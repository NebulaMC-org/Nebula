...
public class TitanSteelChestplate extends CustomItem {
    @Override
    public String getName() {
        return "&fTitan Steel Chestplate";
    }
    ...
    public Map<Attribute, AttributeModifier> getAttributes() {
        ...
        attributes.put(Attribute.GENERIC_ARMOR_TOUGHNESS, new AttributeModifier(UUID.randomUUID(), "generic.armorToughness", 13, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.CHEST));
        attributes.put(Attribute.GENERIC_KNOCKBACK_RESISTANCE, new AttributeModifier(UUID.randomUUID(), "generic.knockbackResistance", 0.25, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.CHEST));
        return attributes;
    }
